...
function activate(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand("acspl.monty", () => __awaiter(this, void 0, void 0, function* () {
        ...
        const panel = vscode.window.createWebviewPanel('monty', '🐎 Monty', vscode.ViewColumn.One, { enableScripts: true });
        let isAuthenticated = false;
        let userCode = null;
        let userId = null;
...
- Always include STOP at the end of ACSPL+ code examples`;
    ...
    context.subscriptions.push(vscode.commands.registerCommand("acspl.montyAI", () => __awaiter(this, void 0, void 0, function* () {
        console.log('=== MONTY AI COMMAND TRIGGERED ===');
        const panel = vscode.window.createWebviewPanel('montyAI', '🐎 Monty', vscode.ViewColumn.One, { enableScripts: true });
        let isAuthenticated = false;
        let userCode = null;
        let userId = null;
        let currentSessionId = null;
